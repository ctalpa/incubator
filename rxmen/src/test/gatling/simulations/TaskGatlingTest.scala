...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "taskId":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "taskDate":"2020-01-01T00:00:00.000Z", "taskStatus":null, "taskPriority":null, "taskType":null}""")).asJSON
            .check(status.is(201))
