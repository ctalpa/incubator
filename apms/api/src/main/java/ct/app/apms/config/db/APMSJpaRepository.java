...
import ct.app.apms.Application;
import ct.app.apms.config.db.validators.UniqueKey;
import ct.app.apms.config.error.ErrorConstants;
import ct.app.apms.util.exception.CustomParametrizedException;
...
public class APMSJpaRepository<T, ID extends Serializable>
    extends SimpleJpaRepository<T, ID> implements APMSRepository <T, ID> {

    private final EntityManager entityManager;

    public APMSJpaRepository(JpaEntityInformation<T, ?> entityInformation, EntityManager entityManager) {
