...
import com.ctalpa.prxmen.repository.LocationRepository;
import com.ctalpa.prxmen.repository.search.LocationSearchRepository;
...
public class LocationResourceIntTest {
    ...
    public void initTest() {
        ...
        location.setRegionName(DEFAULT_REGION_NAME);
        location.setCountryName(DEFAULT_COUNTRY_NAME);
    }
    ...
    public void updateLocation() throws Exception {
        ...
        updatedLocation.setRegionName(UPDATED_REGION_NAME);
        updatedLocation.setCountryName(UPDATED_COUNTRY_NAME);
